...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Sep 2022 pada 16.10
...
INSERT INTO `identitas` (`id_identitas`, `nama_sekolah`, `kode_sekolah`, `npsn`, `status`, `jenjang`, `alamat`, `kepala_sekolah`, `nip`, `kelurahan`, `kecamatan`, `kabupaten`, `kode_pos`, `no_telepon`, `website`, `email`, `latitude`, `longitude`, `maptype`, `radius`, `gis`, `apikey`, `logo`, `bglogin`, `status_pendaftaran`, `status_hasil`, `status_daftar_ulang`, `penomoran`, `stempel`, `ttd`, `header`, `hstempel`, `httd`, `sstempel`, `sttd`, `intergramid`, `maps`) VALUES
(1, 'SMPN 2 TULANG BAWANG BARAT', '12130002', '10808388', 'NEGERI', 'SMP/MTs', 'Jalan Jendral Sudirman No. 1 Murnijaya', 'Sri Mustika Ningsih, S.Pd', '196508151986092003', 'Murnijaya', 'Tumijajar', 'Tulang Bawang Barat', '34592', '07257576180', 'smpn2tulangbawangbarat.sch.id', 'smpn2tubaba@gmail.com', '-4.6218115031750004', '105.10061681270601', 'ROADMAP', 3000, '', 'AIzaSyBchRI_21q70ikqLxY-SxgiRJUY6BWMav8', 'logo_smp.png', 'background.png', '', '', '', 'otomatis', 'stempel.png', 'ttd.png', 'header.png', '110', '95', 'Ya', 'Ya', '926607136', 'OpenStreetMap');
...
(3, 'Teknik', 'Rekayasa Perangkat Lunak', '120'),
...
(1, '2022-09-16 14:07:37', 'admin', 4, 'Menghapus data tabel log'),
(2, '2022-09-16 14:08:36', 'admin', 1, 'Logout');
...
(8, 26, 3, 132, 'fas fa-angle-double-right', 'Menu', 'cms/menu/side-menu', 'navMenu', 1),
(43, 27, 2, 1, 'fas fa-user-secret', 'Manajemen User', '#', '#', 1),
(44, 29, 3, 43, 'fas fa-angle-double-right', 'Groups', 'groups', '2', 1),
...
(114, 16, 3, 109, 'fas fa-angle-double-right', 'Prestasi Peserta', 'prestasipeserta', '#', 1),
(115, 3, 2, 1, 'fas fa-user-graduate', 'Prestasi Peserta', 'member/prestasipeserta', '#', 1),
(116, 22, 2, 1, 'fas fa-bullhorn', 'Pengumuman', 'pengumuman', '#', 1),
(117, 25, 3, 132, 'fas fa-angle-double-right', 'Identitas', 'pengaturan', '#', 1),
(118, 21, 2, 1, 'fas fa-chart-bar', 'Statistik', 'statistik', '#', 1),
(121, 17, 3, 109, 'fas fa-angle-double-right', 'Berkas', 'berkas', '#', 1),
(122, 4, 2, 1, 'fas fa-copy', 'Berkas Pendukung', 'member/berkas', '#', 1),
(125, 20, 3, 109, 'fas fa-angle-double-right', 'Rekap Nilai', 'peserta/nilai_peserta', '#', 1),
(126, 28, 3, 43, 'fas fa-angle-double-right', 'List Users', 'users', '1', 1),
(127, 23, 2, 1, 'fas fa-history', 'Log Pengguna', 'log', '#', 1),
(128, 19, 3, 109, 'fas fa-angle-double-right', 'Nilai Tes dan Wawancara', 'peserta/nilai_teswawancara', '#', 1),
(131, 18, 3, 109, 'fas fa-angle-double-right', 'Nilai Rapor Semester', 'raporsemester', '#', 1),
(132, 24, 2, 1, 'fas fa-cog', 'Pengaturan', '#', '#', 1);
...
(5, '2022', '288', '2022-05-17', '2022-06-30', '2022-07-01', '2022-07-03', '2022-07-04', '2022-07-27', '2022-07-28', 'Aktif', '');
...
(1, '127.0.0.1', 'admin', '$2y$08$knz1f.h3DE9W/c2BRc07hezZl4ZBXxA29k8HqXL8J/ebjEOvcKTKO', '', 'admin@admin.com', '', '5vfXw8AFBMJnY.DC95LkHO611d8355408aeba502', 1579613175, 'fmqjlAIj.o/W3cqHnmFqYu', 1268889823, 1663337205, 1, 'Admin', 'istrator', 'nenemo project', '082184032134', 'admin.jpg'),
(96, '::1', 'panitia', '$2y$08$BT2HRyxQOCU9Eqj2oIvLI.SzBwTCsWpOJMssolb0D8ikxnHTz/ZDS', NULL, 'panitia1@panitia.com', NULL, NULL, NULL, NULL, 1622028644, 1657516976, 1, 'Panitia', 'PPDB', '', '', 'panitia.jpg');
...
--
ALTER TABLE `pengumuman`
  MODIFY `id_pengumuman` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
